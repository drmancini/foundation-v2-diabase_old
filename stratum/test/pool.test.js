...
describe('Test pool functionality', () => {
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 2) {
          ...
          expect(response[0][1]).toBe('Submitted a primary block (Diabase:1) successfully to Diabase\'s daemon instance(s)');
  ...
  test('Test pool manager setup [9]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        expect(text).toBe('Submitted a primary block (Diabase:1) successfully to Diabase\'s daemon instance(s)');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 2) {
          ...
          expect(response[1][1]).toBe('Requested template from primary chain (Diabase:742781) via RPC polling');
          done();
        }
      }
    });
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 3) {
          ...
          expect(response[2][1]).toBe('Requested template from primary chain (Diabase:742780) via RPC polling');
          done();
        }
      }
    });
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM': { 'immature': 10000, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM': { 'generate': 0, 'immature': 20000 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    const expected = {
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM': { 'immature': 5000, 'generate': 0 },
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaN': { 'immature': 5000, 'generate': 0 }};
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM': { 'immature': 8474.10994411, 'generate': 0 },
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaN': { 'immature': 1525.89005589, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM': { 'generate': 10000, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM': { 'immature': 0, 'generate': 20000 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [9]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM': { 'immature': 0, 'generate': -10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [12]', () => {
    ...
    const expected = {
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM': { 'immature': 9570.0056964, 'generate': 0 },
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaN': { 'immature': 429.9943036, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM': { 'immature': -10000, 'generate': 10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], true, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
