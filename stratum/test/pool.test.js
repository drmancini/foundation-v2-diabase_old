...
describe('Test pool functionality', () => {
  ...
  test('Test pool block polling setup [2]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 3) {
        ...
        expect(response[2][1]).toBe('Requested template from primary chain (Dash:742780) via RPC polling');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const blocks1 = {
      ...
      miner: 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM',
      worker: 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM.worker1',
      category: 'immature',
      confirmations: 3,
    ...
    const worker1 = {
      ...
      miner: 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM',
      worker: 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM.worker4',
      identifier: 'master',
      invalid: 0,
      round: '15c8343c-9751-4c67-aafa-29ff296da484',
      solo: false,
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_primary': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_primary': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    worker2.miner = 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaN';
    worker2.worker = 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaN.worker4';
    const expected = {
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_primary': { 'immature': 4999.998, 'generate': 0 },
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaN_false_primary': { 'immature': 4999.998, 'generate': 0 }};
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_primary': { 'immature': 8474.10655446, 'generate': 0 },
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaN_false_primary': { 'immature': 1525.88944554, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_primary': { 'generate': 9999.996, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_primary': { 'immature': 0, 'generate': 19999.992 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [10]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_auxiliary': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [11]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_auxiliary': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [12]', () => {
    ...
    worker2.worker = 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaN.worker4';
    const expected = {
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_auxiliary': { 'immature': 4999.998, 'generate': 0 },
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaN_false_auxiliary': { 'immature': 4999.998, 'generate': 0 }};
  ...
  test('Test pool workers handling [13]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_auxiliary': { 'immature': 8474.10655446, 'generate': 0 },
      'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaN_false_auxiliary': { 'immature': 1525.88944554, 'generate': 0 }};
    pool.handleAuxiliaryWorkers([blocks1], [[worker1, worker2]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_auxiliary': { 'generate': 9999.996, 'immature': 0 }};
    pool.handleAuxiliaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [15]', () => {
    ...
    const expected = { 'XbtkVnc9XRLhxfmafNkafderCWSsXYZJaM_false_auxiliary': { 'immature': 0, 'generate': 19999.992 }};
    pool.handleAuxiliaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
