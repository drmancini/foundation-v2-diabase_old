...
const Loader = function(logger, configMain) {
  ...
  this.handleConfigs = function() {
    ...
    if (fs.existsSync(normalizedPath + 'diabase.js')) {
      config = require(normalizedPath + 'diabase.js');
      ...
      throw new Error('Unable to find diabase.js file. Read the installation/setup instructions');
    }
    return config;
  };
};
